...
include "../DB/connection.php"; // Assuming this sets up the Database class
Database::setupConnection();

$clientId = $_SESSION['client']['id'] ?? $_SESSION['client']; // Adjust based on your session structure
...
$currentDate = date('Y-m-d'); // Current date in Y-m-d format (e.g., 2025-07-28)
$showDashboard = true;
$paymentMessage = '';

if ($subscriptionEndDate && strtotime($currentDate) >= strtotime($subscriptionEndDate)) {
    $showDashboard = false;
    $paymentMessage = "Your monthly payment is finished. Please make payment and re-access the system.";
} elseif ($yearEndDate && strtotime($currentDate) >= strtotime($yearEndDate)) {
    $showDashboard = false;
...
<body>
        ...
        <main>
            <?php if ($showDashboard): ?>
                ...
                <div class="table-data">
                    ...
                    <div class="todo">
                        ...
                        <ul class="todo-list" id="recentActivities">
                            <li class="completed">
            ...
            <?php else: ?>
                <div class="payment-message">
                    <h2><?php echo htmlspecialchars($paymentMessage); ?></h2>
                    <a href="addTask.php">Make Payment</a> <!-- Link to payment page -->
                </div>
            <?php endif; ?>
        </main>
        <!-- MAIN -->
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            // Load dashboard stats only if dashboard is shown
